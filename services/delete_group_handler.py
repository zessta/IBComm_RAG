...
async def handle_delete(req, request):
    ...
    txt_path = os.path.join("/home/aiserver/Desktop/IBComm_RAG/group_texts", f"{groupid}.txt")
    dir_path = os.path.join("/home/aiserver/Desktop/IBComm_RAG/vector_stores", groupid)
